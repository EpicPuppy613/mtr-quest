scoreboard players set @p mtrq_current_quest 24
scoreboard players set @p mtrq_quest_progress 0
scoreboard players set @p mtrq_quest_complete 0
tellraw @p [{"text": "Quest Started: ", "bold": true, "color": "yellow"}, {"text": "Destination Vol. 3: Teufort", "bold": true, "color": "white"}]
